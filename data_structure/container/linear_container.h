...
typedef int (*LinearContainerFind)(LinearContainer *thiz, DataCompareFunc cmp,
                                   void *ctx);
typedef Ret (*LinearContainerForeach)(LinearContainer *thiz,
...
static inline Ret linear_container_insert(LinearContainer *thiz, size_t index,
                                          void *data)
{
    return_val_if_fail(thiz != NULL && thiz->insert != NULL,
                       RET_INVALID_PARAMS);
...
{
    return_val_if_fail(thiz != NULL && thiz->prepend != NULL,
                       RET_INVALID_PARAMS);
...
{
    return_val_if_fail(thiz != NULL && thiz->append != NULL,
                       RET_INVALID_PARAMS);
...
{
    return_val_if_fail(thiz != NULL && thiz->get_by_index != NULL,
                       RET_INVALID_PARAMS);
...
static inline Ret linear_container_set_by_index(LinearContainer *thiz,
                                                size_t index, void *data)
{
    return_val_if_fail(thiz != NULL && thiz->set_by_index != NULL,
                       RET_INVALID_PARAMS);
...
static inline Ret linear_container_foreach(LinearContainer *thiz,
                                           DataVisitFunc visit, void *ctx)
{
    return_val_if_fail(thiz != NULL && thiz->foreach != NULL,
                       RET_INVALID_PARAMS);
