...
{
    __asm__ __volatile__(ATOMIC_SMP_LOCK "addl %1,%0"
                         : "=m"(v->counter)
                         : "ir"(i), "m"(v->counter));
}
...
{
    __asm__ __volatile__(ATOMIC_SMP_LOCK "subl %1,%0"
                         : "=m"(v->counter)
                         : "ir"(i), "m"(v->counter));
}
...
static __inline__ int atomic_sub_and_test(int i, atomic_t *v)
{
    ...
    __asm__ __volatile__(ATOMIC_SMP_LOCK "subl %2,%0; sete %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "ir"(i), "m"(v->counter)
                         : "memory");
    return c;
...
{
    __asm__ __volatile__(ATOMIC_SMP_LOCK "incl %0"
                         : "=m"(v->counter)
                         : "m"(v->counter));
}
...
{
    __asm__ __volatile__(ATOMIC_SMP_LOCK "decl %0"
                         : "=m"(v->counter)
                         : "m"(v->counter));
}
...
static __inline__ int atomic_dec_and_test(atomic_t *v)
{
    ...
    __asm__ __volatile__(ATOMIC_SMP_LOCK "decl %0; sete %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "m"(v->counter)
                         : "memory");
    return c != 0;
...
static __inline__ int atomic_inc_and_test(atomic_t *v)
{
    ...
    __asm__ __volatile__(ATOMIC_SMP_LOCK "incl %0; sete %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "m"(v->counter)
                         : "memory");
    return c != 0;
...
static __inline__ int atomic_add_negative(int i, atomic_t *v)
{
    ...
    __asm__ __volatile__(ATOMIC_SMP_LOCK "addl %2,%0; sets %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "ir"(i), "m"(v->counter)
                         : "memory");
    return c;
...
static __inline__ int ia64_atomic_add(int i, atomic_t *v)
{
    int old, new;
...
static __inline__ int ia64_atomic_sub(int i, atomic_t *v)
{
    int old, new;
    // CMPXCHG_BUGCHECK_DECL
...
static __inline__ int atomic_sub_return(int a, atomic_t *v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%2		# atomic_sub_return\n\
	subf	%0,%1,%0\n\
	stwcx.	%0,0,%2\n\
	bne-	1b" SMP_ISYNC
                         : "=&r"(t)
...
static __inline__ int atomic_inc_return(atomic_t *v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%1		# atomic_inc_return\n\
	addic	%0,%0,1\n\
	stwcx.	%0,0,%1\n\
	bne-	1b" SMP_ISYNC
                         : "=&r"(t)
...
static __inline__ int atomic_dec_return(atomic_t *v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%1		# atomic_dec_return\n\
	addic	%0,%0,-1\n\
	stwcx.	%0,0,%1\n\
	bne-	1b" SMP_ISYNC
                         : "=&r"(t)
...
static __inline__ int atomic_dec_if_positive(atomic_t *v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%1		# atomic_dec_if_positive\n\
	addic.	%0,%0,-1\n\
	blt-	2f\n\
	stwcx.	%0,0,%1\n\
	bne-	1b" SMP_ISYNC "\n\
...
extern __inline__ int atomic_add_return(int i, atomic_t *v)
{
    ...
    __asm__ __volatile__(".set push               # atomic_add_return\n"
                         ".set noreorder                             \n"
                         ".set mips2                                 \n"
                         "1:   ll      %1, %2                        \n"
                         "     addu    %0, %1, %3                    \n"
